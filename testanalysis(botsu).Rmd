...
plot(ggo)
gpp<- ggplot(NULL)
gpp<- gpp + geom_line(g1,aes(day,budget,colour=factor()))
gpp<- gpp + geom_line(data=b1,aes(x=day,y=repaircost,colour=factor(bridgeid)))
plot(gpp)
```
...
plot(ggo)
gpp<- ggplot(NULL)
gpp<- gpp + geom_line(g2,aes(day,budget,colour=factor()))
gpp<- gpp + geom_line(data=b2,aes(x=day,y=repaircost,colour=factor(bridgeid)))
plot(gpp)
gp<-ggplot(
p2,
aes(
...
plot(ggo)
gpp<- ggplot(NULL)
gpp<- gpp + geom_line(g3,aes(day,budget,colour=factor()))
gpp<- gpp + geom_line(data=b3,aes(x=day,y=repaircost,colour=factor(bridgeid)))
plot(gpp)
gp<-ggplot(
p3,
aes(

...
デザインデータブック(2011,日本橋梁建設協会)によれば橋の建設費用は次の式によって推定される.以下,橋xの長さをLx(m),鋼材使用量をIRx(ton)とする.

**(また鋼材の値段は60万円/ton,幅員は12mとおく.)後ろに回す？**

ICx=Lx*IRx*(鋼材の値段)*(橋xの幅員) 

Equation 10 橋の建設費用の推定式

また同書によれば鋼材使用量は橋の長さから次の式を用いて推定することができる.

IRx=55*exp(0.03*Lx)*0.01
